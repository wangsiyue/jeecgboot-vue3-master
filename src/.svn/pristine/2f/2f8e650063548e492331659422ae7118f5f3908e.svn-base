...
export const columns: BasicColumn[] = [
   ...
   },
   {
    title: '制样日期',
    align:"center",
    dataIndex: 'samplePreparationDate'
   },
   {
    title: '测量时间',
    align:"center",
...
//子表单数据
//子表表格配置
export const originalSpectrumAnalysisDetails3Columns: JVxeColumn[] = [
    {
      title: '序号',
      key: 'serialNo',
