...
<script lang="ts" setup>
  ...
  const [registerTable] = useTable({
    ...
    dataSource: [
      ...
      { id: 0, name: '小鹿', point: 33, level: 9, updateTime: '2019-8-10' },
      { id: 0, name: '小王', point: 6, level: 1, updateTime: '2019-8-13' },
      { id: 0, name: '李四', point: 53, level: 8, updateTime: '2019-8-12' },
      { id: 1, name: '小红', point: 44, level: 5, updateTime: '2019-8-11' },
      { id: 1, name: '王五', point: 97, level: 10, updateTime: '2019-8-10' },
